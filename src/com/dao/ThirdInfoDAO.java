...
public void addThird(String regEmail,String regPwd,String thirdName,String phone,String address){
	...
	//String sql  = "insert into dbo.ThirdInfo values('"+regEmail+"','"+regPwd+"','"+thirdName+"','"+registerTime+"',1,'"+phone+"','"+address+"')";
	String sql  = "INSERT INTO  thirdinfo (`email`, `pwd`, `thirdname`, `registerTime`, `isCooled`, `phone`, `address`) VALUES ('"+regEmail+"','"+regPwd+"','"+thirdName+"','"+registerTime+"',1,'"+phone+"','"+address+"');";
...
public boolean checkEmail(String regEmail){
	...
	public ArrayList<Object> getPageModel(PageModel pm){
			...
			String sql  = "select * from    ThirdInfo order by id desc ";
...
public ArrayList<Object> searchThirdInfo(PageModel pm,String key){
	...
	String sql  = "select * from   ThirdInfo where email like '%"+key+"%'   order by id desc ";
	return DBConn.ExecuteQuery(sql, new ThirdInfo());
}
