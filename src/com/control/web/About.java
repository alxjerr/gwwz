		...
		/*	if(method != null){
				if(method.equals("insert")){
					...
					if(goodsEvaluateList != null){
						out.println("<font color='#FF6699'><strong>用户留言记录：</strong></font><br/><br/>");
						...
						out.println("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='button' value='提交留言' style='height: 30px;padding-top: 3px' onclick='return sendRequest()'/>");
...
PublicToolShowGooodsTypeList.showGoodsTypeList(request, response, cp);
				...
				request.getRequestDispatcher("../web/about.jsp").forward(request, response);
		//	}
	}
