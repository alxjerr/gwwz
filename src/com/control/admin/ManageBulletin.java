...
public class ManageBulletin extends HttpServlet {
	...
	public  static void deleteBulletin(HttpServletRequest request, HttpServletResponse response)
		throws ServletException, IOException {
			...
			if(PublicToolCheckParam.checkNullAndEmpty(bid)){
					...
					if(PublicToolCheckParam.checkNullAndEmpty(isSearching)){
						...
						PublicToolShowBulletinList.searchBulletin(request, response, cp, key);
						request.setAttribute("key", key);
						request.setAttribute("isSearching", "yes");
					}
					else{
						PublicToolShowBulletinList.showBulletinList(request, response,cp);
					}
			}
	...
	public static void deleteMoreBulletin(HttpServletRequest request, HttpServletResponse response)
		throws ServletException, IOException {
	...
	public static void insertBulletin(HttpServletRequest request, HttpServletResponse response)
		throws ServletException, IOException {
	...
	public static void searchBulletin(HttpServletRequest request, HttpServletResponse response)
		throws ServletException, IOException {
	...
	public static void showAddBulletinPage(HttpServletRequest request, HttpServletResponse response)
		throws ServletException, IOException {
	...
	public static void showManageBulletinPage(HttpServletRequest request, HttpServletResponse response)
		throws ServletException, IOException {
	...
	public static void updateBulletin(HttpServletRequest request, HttpServletResponse response)
	throws ServletException, IOException {
		...
		if(PublicToolCheckParam.checkNullAndEmpty(bid)){
			if(PublicToolCheckParam.checkNullAndEmpty(submit) && submit.equals("1")){
				...
				request.setAttribute("bulletinInfo", bulletinInfo);
