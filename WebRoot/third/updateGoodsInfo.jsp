...
<script language="javascript">
  ...
  <form action="../servlet/tManageGoodsInfo?method=update&goodsId=<%=goodsInfo.getGoodsId()%>&submit=1&thirdId=<%=thirdId%>" method="post" onSubmit="return checkGoodsInfo()" name="form1">
