    ...
    <div id='ct1'> <!-- Item 2 Strat -->
        ...
        <dl class='bitem' id='sunitems1_1'  runat=server>
          ...
          <dd style='display:block' class='sitem' id='items1_1'>
           ...
           <li> <a href="../servlet/tManageGoodsInfo?method=showAddGoodsInfoPage&thirdId=<%=session.getAttribute("thirdId")%>" target="iframe">添加商品</a></li>
  <li><a href="../servlet/tManageGoodsInfo?method=showManageGoodsInfoPage&thirdId=<%=session.getAttribute("thirdId")%>" target="iframe">商品信息管理</a></li>
              </ul>
          </dd>
        </dl>
        ...
        <dl class='bitem' id='sunitems2_1'   runat=server>
          ...
          <dd style='display:block' class='sitem' id='items2_1'>
            <ul class='sitemu'>
              <li><a href="../servlet/tManageOrder?method=showManageOrderPage&thirdId=<%=session.getAttribute("thirdId")%>" target="iframe">订单信息管理</a></li>
        ...
        <dl class='bitem' id='sunitems4_1' runat=server>
          ...
          <dd style='display:block' class='sitem' id='items4_1'>
            <ul class='sitemu'>
              <li><a href="../servlet/tUpdateUserInfo?method=showUpdatePasswordPage&thirdId=<%=session.getAttribute("thirdId")%>" target="iframe">修改密码</a></li>
<li>              <a href="../servlet/tUpdateUserInfo?method=showUpdateUserNamedPage&thirdId=<%=session.getAttribute("thirdId")%>" target="iframe">修改资料</a></li>
            </ul>
          </dd>
        </dl>
