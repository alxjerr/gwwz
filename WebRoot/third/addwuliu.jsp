...
<html>
      ...
      <td height="100"><table width="100%" border="1" cellpadding="0" cellspacing="0" style="font-size:13px; text-align: center;"  bordercolor="#9999FF">
        ...
        <% 		
      			...
      			OrderDetailInfo wd = orderWuliuInfoList.get(i);
	      				...
	      				out.println("<td><div align='center'><a href='#' onclick=deleteWuliu("+wd.getid()+","+wd.getOrderId()+","+session.getAttribute("thirdId")+")>删除</a></div></td>");
	      				out.println("</tr>");
	      			}
	      		}else{
	       %>
  ...
  <tr>
    <td colspan="2"><strong><font size="6" color="#0099FF">□</font><font color="#666666" size="3">&nbsp;添加物流信息</font></strong></td>
  </tr>
  <tr>
    <td height="15" colspan="2"><hr  width="100%" style="height: 2px;"/></td>
  </tr>
  <tr>
    <td><strong>操作日期：</strong></td>
    <td>
