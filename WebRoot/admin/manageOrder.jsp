    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:13px;">
        <tr>
            <td width="100%" height="36">
                <strong><font size="6" color="#0099FF">□&nbsp;</font><font color="#666666" size="3">订单信息管理</font></strong>
            </td>
            <td height="36">
                <div align="right">
                    <input id="key" type="text" name="key" style="height: 24px;width: 250px;padding-top: 2px;padding-left:20px;background-image: url(../image/icon/key_search.gif);background-repeat: no-repeat"/>
                </div>
            </td>
            <td>
                <input type="button" value="查询" style="height: 26px;width: 70px;padding-top: 2px" onClick="return searchOrder()"/>
            </td>
            <td>
                <input type="submit" value="删除订单" style="height: 26px;width: 70px;padding-top: 2px" onClick="return deletMoreOrder()"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td height="147" colspan="4">
                统计信息 订单总数：<%=request.getAttribute("sumCount")%>，其中已确认：<%=request.getAttribute("queren")%>
                ，未确认：<%=request.getAttribute("wqueren")%>，退货：<%=request.getAttribute("tuihuo")%>
                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0" style="font-size:13px" bordercolor="#9999FF">
                    <tr height="30">
                        ...
                        <td width="40">
                            <div align="center">
                                <input type="checkbox" id="checkAll" value="checkbox" onClick="selectAll()"/>
                            </div>
                        </td>
                        <td>
                            <div align="center"><font color="#666666">订单编号</font></div>
                        </td>
                        <td>
                            <div align="center"><font color="#666666">订单状态</font></div>
                        </td>
                        <td>
                            <div align="center"><font color="#666666">下单时间</font></div>
                        </td>
                        <td>
                            <div align="center"><font color="#666666">客户账户/邮箱</font></div>
                        </td>
                        <td>
                            <div align="center"><font color="#666666">收货人</font></div>
                        </td>
                        <td>
                            <div align="center"><font color="#666666">固定电话</font></div>
                        </td>
                        <td>
                            ...
                            for (int i = 0; i < orderInfoList.size(); i++) {
                                ...
                                if (PublicToolCheckParam.checkNullAndEmpty(isSearching) && orderInfoList.size() > 1) {
                                    ...
                                    if (od.getStatus() == 0) {
                                        ...
                                        out.println("<a href='../servlet/tManageOrder?method=showaddwuliu&orderId=" + od.getOrderId() + "&thirdId=" + session.getAttribute("thirdId") + "'>管理物流信息</a>");
                        ...
                        <td colspan="10" height="50">
                            <div align="center">共找到<%=request.getAttribute("sumCount")%>条记录&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第<%=request.getAttribute("currentPage")%>
                                /<%=request.getAttribute("sumPageCount")%>页&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                        href="../servlet/ManageOrder?method=<%if(PublicToolCheckParam.checkNullAndEmpty(isSearching)){out.println("search&key="+request.getAttribute("key")+"");}else{out.println("showManageOrderPage");}%>&cp=<%=request.getAttribute("indexPage")%>">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                        href="../servlet/ManageOrder?method=<%if(PublicToolCheckParam.checkNullAndEmpty(isSearching)){out.println("search&key="+request.getAttribute("key")+"");}else{out.println("showManageOrderPage");}%>&cp=<%=request.getAttribute("upPage")%>">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                        href="../servlet/ManageOrder?method=<%if(PublicToolCheckParam.checkNullAndEmpty(isSearching)){out.println("search&key="+request.getAttribute("key")+"");}else{out.println("showManageOrderPage");}%>&cp=<%=request.getAttribute("nextPage")%>">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                        href="../servlet/ManageOrder?method=<%if(PublicToolCheckParam.checkNullAndEmpty(isSearching)){out.println("search&key="+request.getAttribute("key")+"");}else{out.println("showManageOrderPage");}%>&cp=<%=request.getAttribute("lastPage")%>">尾页</a>
                            </div>
                        </td>
                    </tr>
                </table>
