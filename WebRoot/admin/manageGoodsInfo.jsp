    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:13px;">
        <tr>
            <td width="100%" height="36"><strong><font size="6" color="#0099FF">□&nbsp;</font><font color="#666666"
                                                                                                    size="3">商品信息管理</font></strong>
            </td>
            <td height="36">
                <div align="right"><input type="text" name="key"
            ...
            <td><input type="button" value="查询" style="height: 26px;width: 70px;padding-top: 2px"
                       onClick="return searchGoodsInfo()"/></td>
            <td><input type="button" value="添加商品" style="height: 26px;width: 70px;padding-top: 2px"
                       onClick="showAddGoodsInfoPage()"/></td>
            <td><input type="submit" value="删除商品" style="height: 26px;width: 70px;padding-top: 2px"
                       onClick="return deletMoreGoodsInfo()"/></td>
            ...
            <td height="147" colspan="12">
                <table width="100%" border="1" cellpadding="0" cellspacing="0" style="font-size:13px"
                    ...
                    <tr height="30">
                        ...
                        <td width="55">
                            <div align="center"><font color="#666666">商品编号</font></div>
                        </td>
                        <td width="85">
                            <div align="center"><font color="#666666">商品类别</font></div>
                        </td>
                        <td>
                            <div align="center"><font color="#666666">商品名称</font></div>
                        </td>
                        <td width="65">
                            <div align="center"><font color="#666666">商品价格</font></div>
                        </td>
                        <td width="55">
                            <div align="center"><font color="#666666">发布时间</font></div>
                        </td>
                        <td width="110">
                            <div align="center"><font color="#666666">剩余数量</font></div>
                        </td>
                        <td width="110">
                            <div align="center"><font color="#666666">所属商户</font></div>
                        </td>
                        <td width="55">
                            <div align="center"><font color="#666666">商品状态</font></div>
                        </td>
                        <td>
                            <div align="center"><font color="#666666">审核状态</font></div>
                        </td>
                        <td width="70">
                        ...
                        if (goodsInfoList == null || goodsInfoList.toString().equals("[]")) {
                            ...
                            for (int i = 0; i < goodsInfoList.size(); i++) {
                                ...
                                if (PublicToolCheckParam.checkNullAndEmpty(isSearching) && goodsInfoList.size() > 1) {
                                    out.println("<a href='../servlet/ManageGoodsInfo?method=update&goodsId=" + gd.getGoodsId() + "'>修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onclick=deleteGoodsInfoOfSearching(" + gd.getGoodsId() + "," + request.getAttribute("key") + ")>删除</a>");
                                    if (gd.getIsCooled() == 1) {
                                        out.println(" <a href='#' onclick=coolGoodsInfoOfSearching(" + gd.getGoodsId() + "," + gd.getIsCooled() + "," + request.getAttribute("key") + ")>审核通过</a>");
                                    } else {
                                        out.println(" <a href='#' onclick=coolGoodsInfoOfSearching(" + gd.getGoodsId() + "," + gd.getIsCooled() + "," + request.getAttribute("key") + ")>取消审核</a>");
                                    }
                                } else {
                                    out.println("<a href='../servlet/ManageGoodsInfo?method=update&goodsId=" + gd.getGoodsId() + "'>修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onclick=deleteGoodsInfo(" + gd.getGoodsId() + ")>删除</a>");
                                    if (gd.getIsCooled() == 1) {
                                        out.println(" <a href='#' onclick=coolGoodsInfo(" + gd.getGoodsId() + "," + gd.getIsCooled() + ")>审核通过</a>");
                                    } else {
                                        out.println(" <a href='#' onclick=coolGoodsInfo(" + gd.getGoodsId() + "," + gd.getIsCooled() + ")>取消审核</a>");
                                    }
                                }
                        ...
                        <td colspan="13" height="50">
                            <div align="center">共找到<%=request.getAttribute("sumCount")%>条记录&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第<%=request.getAttribute("currentPage")%>
                                /<%=request.getAttribute("sumPageCount")%>页&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                        href="../servlet/ManageGoodsInfo?method=<%if(PublicToolCheckParam.checkNullAndEmpty(isSearching)){out.println("search&key="+request.getAttribute("key")+"");}else{out.println("showManageGoodsInfoPage");}%>&cp=<%=request.getAttribute("indexPage")%>">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                        href="../servlet/ManageGoodsInfo?method=<%if(PublicToolCheckParam.checkNullAndEmpty(isSearching)){out.println("search&key="+request.getAttribute("key")+"");}else{out.println("showManageGoodsInfoPage");}%>&cp=<%=request.getAttribute("upPage")%>">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                        href="../servlet/ManageGoodsInfo?method=<%if(PublicToolCheckParam.checkNullAndEmpty(isSearching)){out.println("search&key="+request.getAttribute("key")+"");}else{out.println("showManageGoodsInfoPage");}%>&cp=<%=request.getAttribute("nextPage")%>">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                        href="../servlet/ManageGoodsInfo?method=<%if(PublicToolCheckParam.checkNullAndEmpty(isSearching)){out.println("search&key="+request.getAttribute("key")+"");}else{out.println("showManageGoodsInfoPage");}%>&cp=<%=request.getAttribute("lastPage")%>">尾页</a>
                            </div>
                        </td>
                    </tr>
                </table>
