    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:13px;">
        <tr>
            <td width="100%" height="36">
                <strong><font size="6" color="#0099FF">□&nbsp;</font><font color="#666666" size="3">商品子类型管理</font></strong>
            </td>
            <td height="36">
                <div align="right">
                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0" style="font-size:13px"
                    ...
                    <tr>
                        <td colspan="5" height="50">
                            <div align="center">
                                共找到<%=request.getAttribute("sumCount")%>条记录
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第<%=request.getAttribute("currentPage")%>
                                /<%=request.getAttribute("sumPageCount")%>页
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="../servlet/ManageDetailType?method=<%if(PublicToolCheckParam.checkNullAndEmpty(isSearching)){out.println("search&key="+request.getAttribute("key")+"");}else{out.println("showManageDetailTypePage");}%>&cp=<%=request.getAttribute("indexPage")%>&typeId=<%=request.getParameter("typeId")%>">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="../servlet/ManageDetailType?method=<%if(PublicToolCheckParam.checkNullAndEmpty(isSearching)){out.println("search&key="+request.getAttribute("key")+"");}else{out.println("showManageDetailTypePage");}%>&cp=<%=request.getAttribute("upPage")%>&typeId=<%=request.getParameter("typeId")%>">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="../servlet/ManageDetailType?method=<%if(PublicToolCheckParam.checkNullAndEmpty(isSearching)){out.println("search&key="+request.getAttribute("key")+"");}else{out.println("showManageDetailTypePage");}%>&cp=<%=request.getAttribute("nextPage")%>&typeId=<%=request.getParameter("typeId")%>">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="../servlet/ManageDetailType?method=<%if(PublicToolCheckParam.checkNullAndEmpty(isSearching)){out.println("search&key="+request.getAttribute("key")+"");}else{out.println("showManageDetailTypePage");}%>&cp=<%=request.getAttribute("lastPage")%>&typeId=<%=request.getParameter("typeId")%>">尾页</a>
                            </div>
                        </td>
                    </tr>
                </table>
