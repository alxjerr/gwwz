...
<body>
<div id="Layer1" style="width:100px;height: 20px"><font color="#999999"><strong><%=goodsTypeInfo.getTypeId()%>
</strong></font></div>
<form action="../servlet/ManageGoodsType?method=update&typeId=<%=goodsTypeInfo.getTypeId()%>&submit=1" method="post"
      onsubmit="return addTypeName()">
    <table width="370" height="200" border="0" cellpadding="0" cellspacing="0" style="font-size:13px;margin-left: 40px">
        <tr>
            <td width="100%" height="36" colspan="2"><strong><font size="6" color="#0099FF">□&nbsp;</font><font
                    color="#666666" size="3">查看/修改商品类型信息</font></strong></td>
        </tr>
        <tr>
            <td colspan="2">
                <hr width="100%"/>
        ...
        <tr>
            <td><font color="#999999"><strong>商品类型编号：</strong></font></td>
            <td><input type="text" style="width: 60px; height: 26px;padding-top: 3px"/></td>
        </tr>
        <tr>
            <td><font color="#999999"><strong>商品类型名称：</strong></font></td>
            <td><input id="typeName" type="text" name="typeName" style="width: 250px; height: 26px;padding-top: 3px"
                       value="<%=goodsTypeInfo.getTypeName()%>"/></td>
        </tr>
        <tr>
            <td colspan="2" style="padding-left: 150px">
                <input type="submit" value="确认" style="width: 50px; height: 26px;padding-top: 3px"/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="button" value="返回" style="width: 50px; height: 26px;padding-top: 3px" onclick="back()"/>
            </td>
        </tr>
    </table>
</form>
