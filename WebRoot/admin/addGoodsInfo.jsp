...
<script language="javascript">
  ...
  <tr>
    <td><strong>商品价格/折扣/数量：</strong></td>
    <td>
    	价格：<input id="title" type="text" name="price"  style="width:80px; height:25px;padding-top: 2px" value=""/>&nbsp;&nbsp;元
    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    	...
    	&nbsp;&nbsp;&nbsp;&nbsp;
    	数量：<input id="countRequire" type="text" name="countRequire"  style="width:60px; height:25px;padding-top: 2px" value=""/>&nbsp;&nbsp;件
    </td>
  </tr>
