...
var responseMSG = null;
		...
		function sendRequest(){
			...
			//采用异步传输,POST方法
			xmlHttp.open("POST","../servlet/tManageGoodsInfo?method=getTypeDetailInfo",true);
			//指定一个HTTP报头
...
function back(){
	...
	window.location.href = "../servlet/tManageGoodsInfo?method=showManageGoodsInfoPage";
	}
