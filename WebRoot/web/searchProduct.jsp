...
<div id="wrap">
  ...
  <div id="main" class="mt10">
    ...
    <div class="fr rightbox">
      <div class="position"> 您当前的位置: <a href="../" target="_top">首页</a> &gt;&gt;搜索商品 </div>
      <div class="mt10 arrangement"> <span class="fl">排列方式</span>
        <ul class="fl ml10">
          <li> <a href='../servlet/SearchProduct?key=<%=request.getAttribute("key")%>&order=price'>价格</a> </li>
          
          <li style="border-right: 1px solid #d9d9d9;"> <a href='../servlet/SearchProduct?key=<%=request.getAttribute("key")%>&order=createdate'>时间</a> </li>
        </ul>
      </div>
	...
	%>
      ...
      <div class="productpage">
		...
		out.println("<a href='../servlet/SearchProduct?cp="+request.getAttribute("indexPage")+"&key="+request.getAttribute("key")+"'>首页</a>&nbsp;&nbsp;&nbsp;");
		out.println("<a href='../servlet/SearchProduct?cp="+request.getAttribute("upPage")+"&key="+request.getAttribute("key")+"'>上一页</a>&nbsp;&nbsp;&nbsp;");
		out.println("<a href='../servlet/SearchProduct?cp="+request.getAttribute("nextPage")+"&key="+request.getAttribute("key")+"'>下一页</a>&nbsp;&nbsp;&nbsp;");
		out.println("<a href='../servlet/SearchProduct?cp="+request.getAttribute("lastPage")+"&key="+request.getAttribute("key")+"'>尾页</a>");
